...
define('_MI_BMCART_SKU_LIST', 'SKU List');
define('_MI_BMCART_IMAGE_LIST', 'Image List');
define('_MI_BMCART_ORDER_LIST', 'Order List');
define('_MI_BMCART_SALES_LIST', 'Sales List');
