...
/**
 * @package user
 * @version $Id: CategoryAdminEditForm.class.php,v 1.1 2007/05/15 02:34:39 minahito Exp $
 */
...
class bmcart_CategoryAdminEditForm extends XCube_ActionForm
{
	...
	{
		return "module.bmcart.CategoryAdminEditForm.TOKEN" . $this->get('category_id');
	}
	...
	function prepare()
	{
		...
		$this->mFieldProperties['category_name']->addMessage('required', _MD_BMCART_ERROR_REQUIRED, _AD_BMCART_ITEM_NAME, '255');
		$this->mFieldProperties['category_name']->addMessage('maxlength', _MD_BMCART_ERROR_MAXLENGTH, _AD_BMCART_ITEM_NAME, '255');
